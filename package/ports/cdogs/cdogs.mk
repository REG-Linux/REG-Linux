...
define CDOGS_INSTALL_TARGET_CMDS
    ...
    # cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/ports/cdogs/gamecontrollerdb.txt $(TARGET_DIR)/usr/share/reglinux/datainit/roms/cdogs/data

    # evmap config
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/ports/cdogs/cdogs.keys $(TARGET_DIR)/usr/share/evmapy
endef
