...
define ECWOLF_COPY_GENERATED_HEADERS
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/ports/ecwolf/arith_$(ECWOLF_GENERATED_HEADER_SUFFIX).h $(ECWOLF_BUILDDIR)/deps/gdtoa/arith.h
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/ports/ecwolf/gd_qnan_$(ECWOLF_GENERATED_HEADER_SUFFIX).h $(ECWOLF_BUILDDIR)/deps/gdtoa/gd_qnan.h
endef
