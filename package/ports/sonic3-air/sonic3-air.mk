...
define SONIC3_AIR_ADD_GLES2_CMAKE
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/ports/sonic3-air/CMakeLists.txt.gles2 $(@D)/Oxygen/sonic3air/build/_gles2/CMakeLists.txt
endef
...
define SONIC3_AIR_EVMAPY
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/ports/sonic3-air/sonic3-air.keys \
