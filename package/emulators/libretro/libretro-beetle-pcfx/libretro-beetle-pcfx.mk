...
LIBRETRO_BEETLE_PCFX_VERSION = f559b8f4e1d72af43537260ee9335556b4a424b8
LIBRETRO_BEETLE_PCFX_SITE = $(call github,REG-Linux,beetle-pcfx-libretro,$(LIBRETRO_BEETLE_PCFX_VERSION))
LIBRETRO_BEETLE_PCFX_LICENSE = GPLv2

LIBRETRO_BEETLE_PCFX_PLATFORM = $(LIBRETRO_PLATFORM)

ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_S922X)$(BR2_PACKAGE_SYSTEM_TARGET_A3GEN2),y)
...
else ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_S905)$(BR2_PACKAGE_SYSTEM_TARGET_S905GEN2),y)
...
else ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_H616)$(BR2_PACKAGE_SYSTEM_TARGET_H700)$(BR2_PACKAGE_SYSTEM_TARGET_H6),y)
LIBRETRO_BEETLE_PCFX_PLATFORM = S905

else ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_RK3568)$(BR2_PACKAGE_SYSTEM_TARGET_S905GEN3),y)
...
LIBRETRO_BEETLE_PCFX_PLATFORM = saphira
