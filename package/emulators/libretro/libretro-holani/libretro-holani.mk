...
LIBRETRO_HOLANI_DEPENDENCIES = host-rustc host-rust-bin clang
...
# Temporary fix for prebuilt clang/llvm (LIBCLANG_PATH)
LIBRETRO_HOLANI_CARGO_ENV = BINDGEN_EXTRA_CLANG_ARGS="-I$(HOST_DIR)/lib/clang/$(CLANG_VERSION_MAJOR)/include/" LIBCLANG_PATH="$(HOST_DIR)/lib"
