...
LIBRETRO_MORPHEUSCAST_XTREME_EXTRA_ARGS = HAVE_OPENMP=1

LIBRETRO_MORPHEUSCAST_XTREME_DEPENDENCIES += libgles

ifeq ($(BR2_ENABLE_DEBUG),y)
    LIBRETRO_MORPHEUSCAST_XTREME_EXTRA_ARGS += DEBUG=y
endif

ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_BCM2837),y)
LIBRETRO_MORPHEUSCAST_XTREME_PLATFORM = rpi3_64
LIBRETRO_MORPHEUSCAST_XTREME_EXTRA_ARGS += FORCE_GLES=1 ARCH=arm64 LDFLAGS=-lrt

else ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_BCM2836),y)
LIBRETRO_MORPHEUSCAST_XTREME_PLATFORM = rpi2
LIBRETRO_MORPHEUSCAST_XTREME_EXTRA_ARGS += FORCE_GLES=1 ARCH=arm LDFLAGS=-lrt
