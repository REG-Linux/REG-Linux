...
define SUPERMODEL_ES_POST_PROCESS
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/supermodel/model3.supermodel.keys $(TARGET_DIR)/usr/share/evmapy
    cp -pr $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/supermodel/NVRAM $(TARGET_DIR)/usr/share/supermodel
endef
