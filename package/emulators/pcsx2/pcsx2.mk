...
define PCSX2_EVMAPY
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/pcsx2/ps2.pcsx2.keys \
...
define PCSX2_TEXTURES
	...
	cp -pr $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/pcsx2/textures/ \
...
define PCSX2_CROSSHAIRS
	...
	cp -pr $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/pcsx2/crosshairs/ \
        $(TARGET_DIR)/usr/pcsx2/bin/resources/
endef
