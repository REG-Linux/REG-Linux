...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_X86_64_ANY),y)
	DOLPHIN_TRIFORCE_DEPENDENCIES = xwayland
endif
...
define DOLPHIN_TRIFORCE_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0555 "$(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/dolphin-triforce/dolphin-triforce.AppImage" "${TARGET_DIR}/usr/bin/dolphin-triforce"
endef
...
define DOLPHIN_TRIFORCE_EVMAP
	...
	cp -prn $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/dolphin-triforce/triforce.dolphin_triforce.keys \
