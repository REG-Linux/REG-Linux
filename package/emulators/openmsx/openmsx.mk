...
define OPENMSX_INSTALL_TARGET_CMDS
    ...
    cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/openmsx/*.keys $(TARGET_DIR)/usr/share/evmapy/
    cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/openmsx/settings.xml $(TARGET_DIR)/usr/share/openmsx
endef
