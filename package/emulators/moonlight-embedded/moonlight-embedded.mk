...
define MOONLIGHT_EMBEDDED_INSTALL_SCRIPTS
	...
	cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/moonlight-embedded/moonlight.moonlight.keys \
        $(TARGET_DIR)/usr/share/evmapy
    cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/moonlight-embedded/moonlight.conf \
        $(TARGET_DIR)/usr/share/moonlight-embedded/
    install -m 0755 \
	    $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/moonlight-embedded/batocera-moonlight \
	    $(TARGET_DIR)/usr/bin/
endef
