...
define PPSSPP_INSTALL_TARGET_CMDS
    ...
    cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/ppsspp/NotoSansCJKjp-DemiLight.ttf \
        $(TARGET_DIR)/usr/share/ppsspp/PPSSPP/Roboto-Condensed.ttf
endef

define PPSSPP_POST_PROCESS
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/emulators/ppsspp/psp.ppsspp.keys \
