...
#
################################################################################
# Version.: Release 2.1.0 on Apr 24, 2024
CDOGS_VERSION = 2.1.0
...
define CDOGS_INSTALL_TARGET_CMDS
    ...
    # cp -f $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/ports/cdogs/gamecontrollerdb.txt $(TARGET_DIR)/usr/share/reglinux/datainit/roms/cdogs/data

    # evmap config
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/ports/cdogs/cdogs.keys $(TARGET_DIR)/usr/share/evmapy
endef
