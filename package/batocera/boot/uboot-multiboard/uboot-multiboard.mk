...
#
################################################################################
ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_RK3288),y)
UBOOT_MULTIBOARD_VERSION = 2024.01
else ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_H616)$(BR2_PACKAGE_SYSTEM_TARGET_RK3328),y)
UBOOT_MULTIBOARD_VERSION = 2024.04
else
UBOOT_MULTIBOARD_VERSION = 2025.01
endif
...
ifneq ($(BR2_PACKAGE_SYSTEM_TARGET_H3)$(BR2_PACKAGE_SYSTEM_TARGET_CHA)$(BR2_PACKAGE_SYSTEM_TARGET_MINI),y)
...
else ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_H3)$(BR2_PACKAGE_SYSTEM_TARGET_CHA)$(BR2_PACKAGE_SYSTEM_TARGET_MINI),y)
UBOOT_MULTIBOARD_MAKE_OPTS += BL32=$(BINARIES_DIR)/bl32.elf
