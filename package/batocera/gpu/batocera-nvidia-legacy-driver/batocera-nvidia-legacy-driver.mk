...
define BATOCERA_NVIDIA_LEGACY_DRIVER_INSTALL_GL_DEV
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_REGLINUX_PATH)/package/nvidia-driver/gl.pc $(STAGING_DIR)/usr/lib/pkgconfig/gl.pc
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_REGLINUX_PATH)/package/nvidia-driver/egl.pc $(STAGING_DIR)/usr/lib/pkgconfig/egl.pc
endef
...
define BATOCERA_NVIDIA_LEGACY_DRIVER_INSTALL_COMMON
...
define BATOCERA_NVIDIA_LEGACY_DRIVER_INSTALL_TARGET_CMDS
	...
	$(call BATOCERA_NVIDIA_LEGACY_DRIVER_INSTALL_COMMON)
endef
