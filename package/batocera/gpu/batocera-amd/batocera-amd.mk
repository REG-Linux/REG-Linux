...
define BATOCERA_AMD_INSTALL_TARGET_CMDS
	...
	install -m 0755 $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/gpu/batocera-amd/S05amd-check \
	    $(TARGET_DIR)/etc/init.d/S001amd-check
	# List
	mkdir -p $(TARGET_DIR)/usr/share/amd
	install -m 0644 $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/gpu/batocera-amd/islands.list \
