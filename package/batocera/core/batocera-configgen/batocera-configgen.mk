...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_VISIONFIVE2),y)
	BATOCERA_CONFIGGEN_SYSTEM=visionfive2
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BANANAPI_F3),y)
	BATOCERA_CONFIGGEN_SYSTEM=bpif3
