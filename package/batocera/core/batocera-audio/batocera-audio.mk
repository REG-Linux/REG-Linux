...
define BATOCERA_AUDIO_INSTALL_TARGET_CMDS
	...
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/core/batocera-audio/80-disable-alsa-reserve.conf \
...
define BATOCERA_AUDIO_STEAM_DECK
	...
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/core/batocera-audio/sof-vangogh-*.* \
