...
define BATOCERA_PACMAN_INSTALL_CONF
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/utils/pacman/userdata_pacman.conf $(TARGET_DIR)/usr/share/reglinux/datainit/system/pacman/pacman.conf
