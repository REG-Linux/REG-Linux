...
TOOLCHAIN_OPTIONAL_LINARO_AARCH64_SUBVERSION = 7.5.0-2019.12
...
ifeq ($(HOSTARCH),x86)
	TOOLCHAIN_OPTIONAL_LINARO_AARCH64_SOURCE = gcc-linaro-$(TOOLCHAIN_OPTIONAL_LINARO_AARCH64_SUBVERSION)-i686_aarch64-linux-gnu.tar.xz
else
	TOOLCHAIN_OPTIONAL_LINARO_AARCH64_SOURCE = gcc-linaro-$(TOOLCHAIN_OPTIONAL_LINARO_AARCH64_SUBVERSION)-x86_64_aarch64-linux-gnu.tar.xz
endif
