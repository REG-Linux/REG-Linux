...
define SUPERMODEL_LEGACY_POST_PROCESS
	...
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/emulators/supermodel-legacy/model3.supermodel.keys $(TARGET_DIR)/usr/share/evmapy
    cp -pr $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/emulators/supermodel-legacy/NVRAM $(TARGET_DIR)/usr/share/supermodel
endef
