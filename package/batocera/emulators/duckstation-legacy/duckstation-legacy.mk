...
ifeq ($(BR2_PACKAGE_REGLINUX_HAS_QT6)$(BR2_PACKAGE_XORG7),yy)
    DUCKSTATION_LEGACY_CONF_OPTS += -DBUILD_QT_FRONTEND=ON
    DUCKSTATION_LEGACY_DEPENDENCIES += reglinux-qt6
else
...
define DUCKSTATION_LEGACY_INSTALL_TARGET_CMDS
    ...
    cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/batocera/emulators/duckstation-legacy/psx.duckstation.keys \
