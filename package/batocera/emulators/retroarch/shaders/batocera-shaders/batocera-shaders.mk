...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_X86)$(BR2_PACKAGE_BATOCERA_TARGET_X86_64_ANY)$(BR2_PACKAGE_BATOCERA_TARGET_SAPHIRA),y)
...
ifeq ($(BR2_PACKAGE_SLANG_SHADERS),y)
    BATOCERA_SHADERS_DEPENDENCIES += slang-shaders
