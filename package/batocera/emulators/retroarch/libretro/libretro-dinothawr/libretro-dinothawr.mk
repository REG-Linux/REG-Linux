...
define LIBRETRO_DINOTHAWR_INSTALL_TARGET_CMDS
	...
	mkdir -p $(TARGET_DIR)/usr/share/reglinux/datainit/roms/dinothawr/dinothawr
	cp -R $(@D)/dinothawr/* $(TARGET_DIR)/usr/share/reglinux/datainit/roms/dinothawr/dinothawr
endef
