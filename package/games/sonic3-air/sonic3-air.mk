...
SONIC3_AIR_VERSION = v26.01.31.0-test
...
define SONIC3_AIR_ADD_GLES2_CMAKE
	...
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/games/sonic3-air/CMakeLists.txt.gles2 $(@D)/Oxygen/sonic3air/build/_gles2/CMakeLists.txt
endef
...
SONIC3_AIR_CONF_OPTS += -DUSE_GLES=ON
