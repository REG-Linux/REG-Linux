...
define ALLLINUXFIRMWARES_LINK_QCA_WIFI_BT
    ...
    cp -rf $(BR2_EXTERNAL_BATOCERA_PATH)/package/firmwares/alllinuxfirmwares/hw2.1/* \
	    $(TARGET_DIR)/lib/firmware/ath11k/WCN6855/hw2.1
    cp -rf $(BR2_EXTERNAL_BATOCERA_PATH)/package/firmwares/alllinuxfirmwares/QCA206X/* \
	    $(TARGET_DIR)/lib/firmware/ath11k/QCA2066
    # bluetooth
    cp -rf $(BR2_EXTERNAL_BATOCERA_PATH)/package/firmwares/alllinuxfirmwares/qca/* \
