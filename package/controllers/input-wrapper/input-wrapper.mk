...
define INPUT_WRAPPER_INSTALL_TARGET_CMDS
    ...
    cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/controllers/input-wrapper/sysconfigs/S60input-wrapper         $(TARGET_DIR)/etc/init.d
    cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/controllers/input-wrapper/sysconfigs/99-input-wrapper.rules   $(TARGET_DIR)/etc/udev/rules.d
endef
