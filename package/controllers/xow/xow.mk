...
define XOW_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/controllers/xow/xow-daemon $(TARGET_DIR)/usr/bin/xow-daemon
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/controllers/xow/99-xow.rules $(TARGET_DIR)/etc/udev/rules.d
endef
