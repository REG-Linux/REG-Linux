...
define ROSHAMBO_CASE_BUILD_CMDS
	...
	(cd $(BR2_EXTERNAL_BATOCERA_PATH)/package/cases/roshambo-case && $(HOST_DIR)/bin/python -m compileall roshambo-case.py)
endef
...
define ROSHAMBO_CASE_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -Dm755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/cases/roshambo-case/S14roshambo       $(TARGET_DIR)/etc/init.d/
	$(INSTALL) -Dm755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/cases/roshambo-case/roshambo-case.py* $(TARGET_DIR)/usr/bin/
endef
