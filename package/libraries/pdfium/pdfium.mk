...
PDFIUM_VERSION = 7557
PDFIUM_SITE = https://github.com/bblanchon/pdfium-binaries/releases/download/chromium/$(PDFIUM_VERSION)
PDFIUM_LICENSE = MIT
...
$(error BR2_PACKAGE_PDFIUM only supports arm, aarch64 or x86_64 targets)
endif
