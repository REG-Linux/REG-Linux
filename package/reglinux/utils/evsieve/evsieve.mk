...
define EVSIEVE_POST_INSTALL_CMDS
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/utils/evsieve/evsieve-merge-devices \
 		$(TARGET_DIR)/usr/bin/evsieve-merge-devices
	$(TARGET_STRIP) -s $(TARGET_DIR)/usr/bin/evsieve
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/utils/evsieve/evsieve-helper $(TARGET_DIR)/usr/bin/evsieve-helper
endef
