...
define REGLINUX_RESOLUTION_INSTALL_TARGET_CMDS
	...
	install -m 0755 $(REGLINUX_RESOLUTION_PATH)/screenshot/screenshot.drm		$(TARGET_DIR)/etc/reglinux/
	install -m 0755 $(REGLINUX_RESOLUTION_PATH)/screenshot/screenshot.sway		$(TARGET_DIR)/etc/reglinux/
	install -m 0755 $(REGLINUX_RESOLUTION_PATH)/screenshot/batocera-screenshot	$(TARGET_DIR)/usr/bin/
endef
