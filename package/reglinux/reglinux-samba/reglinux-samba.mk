...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_X86_ANY)$(BR2_PACKAGE_HOST_LINUX_HEADERS_CUSTOM_4_4)$(BR2_PACKAGE_HOST_LINUX_HEADERS_CUSTOM_5_4),y)
REGLINUX_SAMBA_DEPENDENCIES += samba4
endif

# Everything but those archs will run ksmbd
ifneq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3128)$(BR2_PACKAGE_BATOCERA_TARGET_A3GEN2)$(BR2_PACKAGE_BATOCERA_TARGET_S9GEN4)$(BR2_PACKAGE_BATOCERA_TARGET_X86_ANY),y)
