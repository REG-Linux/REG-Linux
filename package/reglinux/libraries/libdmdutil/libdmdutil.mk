...
define LIBDMDUTIL_INSTALL_SERVER
   ...
   install -m 0755 $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/libraries/libdmdutil/dmd_server.service $(TARGET_DIR)/usr/share/reglinux/services/dmd_real
   install -m 0755 $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/libraries/libdmdutil/dmdserver-config.py $(TARGET_DIR)/usr/bin/dmdserver-config
   # pixelcade
   install -m 0644 -D $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/libraries/libdmdutil/99-pixelcade.rules $(TARGET_DIR)/etc/udev/rules.d/99-pixelcade.rules
   $(INSTALL) -m 0755 -D $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/libraries/libdmdutil/pixelcade-add   $(TARGET_DIR)/usr/bin/pixelcade-add
endef
