...
REGLINUX_SYSTEM_VERSION = 24.06-dev
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2835),y)
	...
	REGLINUX_SYSTEM_ARCH=x86-64-v3
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_ODIN),y)
	REGLINUX_SYSTEM_ARCH=odin
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_VISIONFIVE2)$(BR2_PACKAGE_BATOCERA_BANANAPI_F3),y)
...
define REGLINUX_SYSTEM_INSTALL_TARGET_CMDS
	...
	echo -n "$(REGLINUX_SYSTEM_ARCH)" > $(TARGET_DIR)/usr/share/batocera/batocera.arch
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/reglinux/core/reglinux-system/batocera.conf \
	    $(TARGET_DIR)/usr/share/batocera/datainit/system

	# batocera-boot.conf
	$(INSTALL) -D -m 0644 \
	    $(BR2_EXTERNAL_BATOCERA_PATH)/package/reglinux/core/reglinux-system/batocera-boot.conf \
	...
	if test -d \
		$(BR2_EXTERNAL_BATOCERA_PATH)/package/reglinux/core/reglinux-system/sysconfigs/${REGLINUX_SYSTEM_ARCH}; \
		then cp -pr \
		$(BR2_EXTERNAL_BATOCERA_PATH)/package/reglinux/core/reglinux-system/sysconfigs/${REGLINUX_SYSTEM_ARCH}/* \
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/reglinux/core/reglinux-system/xdg.sh \
	    $(TARGET_DIR)/etc/profile.d/xdg.sh
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/reglinux/core/reglinux-system/dbus.sh \
