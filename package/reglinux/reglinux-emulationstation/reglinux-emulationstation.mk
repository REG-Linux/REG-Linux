...
#
################################################################################
# Last update: Commits on May 31, 2024
REGLINUX_EMULATIONSTATION_VERSION = e1dd985cd150b1a6e7b0c7db6ac93ec809c28d5a
...
# on SPLASH_FFMPEG, the splash with video + es splash is ok
ifeq ($(BR2_PACKAGE_REGLINUX_SPLASH_FFPLAY),y)
REGLINUX_EMULATIONSTATION_ARGS = $${EXTRA_OPTS}
endif

# es splash is ok when there is no video
ifeq ($(BR2_PACKAGE_REGLINUX_SPLASH_IMAGE),y)
REGLINUX_EMULATIONSTATION_ARGS = $${EXTRA_OPTS}
endif
