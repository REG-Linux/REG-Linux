...
#
################################################################################
# Version.: Release 2.2.0 on Dec 7, 2024
CDOGS_VERSION = 2.2.0
...
define CDOGS_INSTALL_TARGET_CMDS
    ...
    # cp -f $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/ports/cdogs/gamecontrollerdb.txt $(TARGET_DIR)/usr/share/reglinux/datainit/roms/cdogs/data

    # evmap config
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/ports/cdogs/cdogs.keys $(TARGET_DIR)/usr/share/evmapy
endef
