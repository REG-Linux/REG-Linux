...
define OPENJAZZ_POST_PROCESS
	...
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/ports/openjazz/openjazz.keys $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/ports/openjazz/openjazz.cfg $(TARGET_DIR)/usr/share/reglinux/datainit/system/configs/openjazz.cfg
endef
