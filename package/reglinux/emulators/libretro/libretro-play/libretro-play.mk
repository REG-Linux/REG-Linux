...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_HAS_LIBGL),y)
LIBRETRO_PLAY_DEPENDENCIES = libgl libglew libglu
endif
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_HAS_LIBGLES),y)
LIBRETRO_PLAY_DEPENDENCIES = libgles
endif
