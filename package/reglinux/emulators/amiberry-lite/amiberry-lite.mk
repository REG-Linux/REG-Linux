...
define AMIBERRY_LITE_EVMAP
	...
	cp -prn $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/emulators/amiberry-lite/controllers/amiga500.amiberry.keys \
		$(TARGET_DIR)/usr/share/evmapy
	cp -prn $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/emulators/amiberry-lite/controllers/amiga1200.amiberry.keys \
		$(TARGET_DIR)/usr/share/evmapy
	cp -prn $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/emulators/amiberry-lite/controllers/amigacd32.amiberry.keys \
		$(TARGET_DIR)/usr/share/evmapy
endef
