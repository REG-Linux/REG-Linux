...
AZAHAR_VERSION = a4180a8c5defd3beab492f2c89a5be2b3ed24c0a
...
define AZAHAR_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D $(@D)/buildroot-build/bin/Release/$(AZAHAR_BIN) \
		$(TARGET_DIR)/usr/bin/
endef

define AZAHAR_EVMAP
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp -prn $(BR2_EXTERNAL_REGLINUX_PATH)/package/reglinux/emulators/azahar/3ds.azahar.keys \
