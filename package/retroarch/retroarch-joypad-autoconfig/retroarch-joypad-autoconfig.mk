...
RETROARCH_JOYPAD_AUTOCONFIG_INSTALL_DIR = $(TARGET_DIR)/usr/share/libretro/autoconfig
...
define RETROARCH_JOYPAD_AUTOCONFIG_INSTALL_TARGET_CMDS
	...
	cp -r $(BR2_EXTERNAL_REGLINUX_PATH)/package/retroarch/retroarch-joypad-autoconfig/rocknix/* $(RETROARCH_JOYPAD_AUTOCONFIG_INSTALL_DIR)
endef
