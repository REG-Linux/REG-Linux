...
def _extract_bezel_set(system) -> str | None:
    """
...
def _get_guns_borders_size(guns, system_config) -> str | None:
    """
...
def _get_bezel_info(bezel_set: str | None, system, rom) -> dict | None:
    """
