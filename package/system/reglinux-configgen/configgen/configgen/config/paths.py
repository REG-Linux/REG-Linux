"""System paths used throughout the REG-Linux ConfigGen.

This module defines all the constant paths used for configurations, assets,
and user data throughout the system.
"""
...
RUN_DIR: Final[Path] = Path("/var/run")
EMULATORLAUNCHER_PERF: Final[Path] = RUN_DIR / "emulatorlauncher.perf"
EMULATORLAUNCHER_PROF: Final[Path] = RUN_DIR / "emulatorlauncher.prof"
HUD_CONFIG: Final[Path] = RUN_DIR / "hud.config"
