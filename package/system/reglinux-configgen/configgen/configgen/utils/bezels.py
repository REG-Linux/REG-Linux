...
def getBezelInfos(rom, bezel, systemName, emulator):
    ...
    overlay_info_file = systemFiles.overlayUser + "/" + bezel + "/games/" + systemName + "/" + romBase + ".info"
    overlay_png_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + systemName + "/" + romBase + ".png"
    overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + systemName + "/" + romBase + ".lay"
    overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + systemName + "/" + romBase + ".zip"
    bezel_game = True
    if not os.path.exists(overlay_png_file):
        overlay_info_file = systemFiles.overlaySystem + "/" + bezel + "/games/" + systemName + "/" + romBase + ".info"
        overlay_png_file  = systemFiles.overlaySystem + "/" + bezel + "/games/" + systemName + "/" + romBase + ".png"
        overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + systemName + "/" + romBase + ".lay"
        overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + systemName + "/" + romBase + ".zip"
        bezel_game = True
        if not os.path.exists(overlay_png_file):
            overlay_info_file = systemFiles.overlayUser + "/" + bezel + "/games/" + romBase + ".info"
            overlay_png_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + romBase + ".png"
            overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + romBase + ".lay"
            overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + romBase + ".zip"
            bezel_game = True
            if not os.path.exists(overlay_png_file):
                overlay_info_file = systemFiles.overlaySystem + "/" + bezel + "/games/" + romBase + ".info"
                overlay_png_file  = systemFiles.overlaySystem + "/" + bezel + "/games/" + romBase + ".png"
                overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + romBase + ".lay"
                overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/games/" + romBase + ".zip"
                bezel_game = True
                if not os.path.exists(overlay_png_file):
                    if altDecoration != 0:
                      overlay_info_file = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".info"
                      overlay_png_file  = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".png"
                      overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".lay"
                      overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".zip"
                      bezel_game = False
                    if not os.path.exists(overlay_png_file):
                        overlay_info_file = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + ".info"
                        overlay_png_file  = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + ".png"
                        overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + ".lay"
                        overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/systems/" + systemName + ".zip"
                        bezel_game = False
                        if not os.path.exists(overlay_png_file):
                            if altDecoration != 0:
                              overlay_info_file = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".info"
                              overlay_png_file  = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".png"
                              overlay_layout_file  = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".lay"
                              overlay_mamezip_file  = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + "-" + str(altDecoration) + ".zip"
                              bezel_game = False
                            if not os.path.exists(overlay_png_file):
                                overlay_info_file = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + ".info"
                                overlay_png_file  = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + ".png"
                                overlay_layout_file  = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + ".lay"
                                overlay_mamezip_file  = systemFiles.overlaySystem + "/" + bezel + "/systems/" + systemName + ".zip"
                                bezel_game = False
                                if not os.path.exists(overlay_png_file):
                                    overlay_info_file = systemFiles.overlayUser + "/" + bezel + "/default-" + str(altDecoration) + ".info"
                                    overlay_png_file  = systemFiles.overlayUser + "/" + bezel + "/default-" + str(altDecoration) + ".png"
                                    overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/default-" + str(altDecoration) + ".lay"
                                    overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/default-" + str(altDecoration) + ".zip"
                                    bezel_game = True
                                    if not os.path.exists(overlay_png_file):
                                      overlay_info_file = systemFiles.overlayUser + "/" + bezel + "/default.info"
                                      overlay_png_file  = systemFiles.overlayUser + "/" + bezel + "/default.png"
                                      overlay_layout_file  = systemFiles.overlayUser + "/" + bezel + "/default.lay"
                                      overlay_mamezip_file  = systemFiles.overlayUser + "/" + bezel + "/default.zip"
                                      bezel_game = True
                                      if not os.path.exists(overlay_png_file):
                                          overlay_info_file = systemFiles.overlaySystem + "/" + bezel + "/default-" + str(altDecoration) + ".info"
                                          overlay_png_file  = systemFiles.overlaySystem + "/" + bezel + "/default-" + str(altDecoration) + ".png"
                                          overlay_layout_file  = systemFiles.overlaySystem + "/" + bezel + "/default-" + str(altDecoration) + ".lay"
                                          overlay_mamezip_file  = systemFiles.overlaySystem + "/" + bezel + "/default-" + str(altDecoration) + ".zip"
                                          bezel_game = True
                                          if not os.path.exists(overlay_png_file):
                                            overlay_info_file = systemFiles.overlaySystem + "/" + bezel + "/default.info"
                                            overlay_png_file  = systemFiles.overlaySystem + "/" + bezel + "/default.png"
                                            overlay_layout_file  = systemFiles.overlaySystem + "/" + bezel + "/default.lay"
                                            overlay_mamezip_file  = systemFiles.overlaySystem + "/" + bezel + "/default.zip"
                                            bezel_game = True
                                            if not os.path.exists(overlay_png_file):
                                              return None
