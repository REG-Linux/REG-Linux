...
from systemFiles import CONF, SAVES, BIOS, SCREENSHOTS, LOGDIR
...
def setAmiberryConfig(system):
    ...
    amiberryConfig.save("default_vkbd_transparency", system.config.get("amiberry_vkbd_transparency", "60"))
    amiberryConfig.save("default_vkbd_language", system.config.get("amiberry_vkbd_language", "US"))
