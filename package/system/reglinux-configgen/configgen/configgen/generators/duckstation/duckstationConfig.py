...
def readWriteFile(system, playersControllers):
    ...
    # Save config
    if not os.path.exists(os.path.dirname(duckstationConfigFile)):
        os.makedirs(os.path.dirname(duckstationConfigFile))
    with open(duckstationConfigFile, 'w') as configfile:
