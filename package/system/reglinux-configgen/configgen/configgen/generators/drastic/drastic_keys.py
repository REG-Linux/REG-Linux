"""Evmapy controller mappings for Drastic (Nintendo DS emulator).

This module defines button mappings for Drastic games using evmapy.
Mappings are loaded directly without file I/O for optimal performance.

Example:
    from configgen.generators.drastic import drastic_keys
    config = drastic_keys.get_config()

"""

from typing import Any

# Evmapy configuration for Drastic controller
    ...
    "actions_player1": [
        {
            ...
            "type": "key",
            "target": ["KEY_UP"],
            "description": "Joy2Pad Up",
        },
        {
            "trigger": ["joystick1down"],
            "type": "key",
            "target": ["KEY_DOWN"],
            "description": "Joy2Pad Down",
        },
        {
            "trigger": ["joystick1left"],
            "type": "key",
            "target": ["KEY_LEFT"],
            "description": "Joy2Pad Left",
        },
        {
            "trigger": ["joystick1right"],
            "type": "key",
            "target": ["KEY_RIGHT"],
            "description": "Joy2Pad Right",
        },
        {
            "trigger": ["up"],
            "type": "key",
...
def get_config() -> dict[str, Any]:
    """Return the evmapy configuration for Drastic.
