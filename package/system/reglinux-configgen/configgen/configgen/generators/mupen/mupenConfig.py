...
MUPEN_MAPPING_SYSTEM_PATH = (
    "/usr/share/reglinux/datainit/system/configs/mupen64/input.xml"
)
        ...
        if "guide" in controllers["1"].inputs:
            if "start" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["start"]),
                    ),
                )
            if (
                system.isOptSet("mupen64-controller1")
                and system.config["mupen64-controller1"] == "n64limited"
            ):
            ...
            if "y" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["y"]),
                    ),
                )
            if "x" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["x"]),
                    ),
                )
            if "pageup" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["pageup"]),
                    ),
                )
            if "up" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["up"]),
                    ),
                )
            if "right" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["right"]),
                    ),
                )
            if "a" in controllers["1"].inputs:
                iniConfig.set(
                    ...
                    '"J{}{}/{}"'.format(
                        controllers["1"].index,
                        createButtonCode(controllers["1"].inputs["hotkey"]),
                        createButtonCode(controllers["1"].inputs["a"]),
                    ),
                )
            if "b" in controllers["1"].inputs:
