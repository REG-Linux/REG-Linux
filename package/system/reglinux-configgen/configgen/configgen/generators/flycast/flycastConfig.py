...
def setFlycastConfig(
    ...
    if system.isOptSet("flycast_render_resolution"):
        flycastConfig.set(
            "config",
            "rend.Resolution",
            str(system.config["flycast_render_resolution"]),
        )
    else:
    ...
    if system.isOptSet("flycast_ratio"):
        flycastConfig.set(
            "config",
            "rend.WideScreen",
            str(system.config["flycast_ratio"]),
        )
    else:
    ...
    if system.isOptSet("flycast_rotate"):
        flycastConfig.set(
            "config",
            "rend.Rotate90",
            str(system.config["flycast_rotate"]),
        )
    else:
    ...
    if system.isOptSet("flycast_language"):
        flycastConfig.set(
            "config",
            "Dreamcast.Language",
            str(system.config["flycast_language"]),
        )
    else:
    ...
    if system.isOptSet("flycast_loadstate"):
        flycastConfig.set(
            "config",
            "Dreamcast.AutoLoadState",
            str(system.config["flycast_loadstate"]),
        )
    else:
    ...
    if system.isOptSet("flycast_savestate"):
        flycastConfig.set(
            "config",
            "Dreamcast.AutoSaveState",
            str(system.config["flycast_savestate"]),
        )
    else:
    ...
    if system.isOptSet("flycast_winCE"):
        flycastConfig.set(
            "config",
            "Dreamcast.ForceWindowsCE",
            str(system.config["flycast_winCE"]),
        )
    else:
