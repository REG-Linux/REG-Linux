...
from .pcsx2Config import setPcsx2Reg, setPcsx2Config, configureAudio, PCSX2_CONFIG_DIR, PCSX2_SOURCE_PATH, PCSX2_BIN_PATH, PCSX2_PATCHES_PATH, PCSX2_BIOS_DIR
...
class Pcsx2Generator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        # FIXME Config files
        setPcsx2Reg()
        setPcsx2Config(system, rom, playersControllers, metadata, guns, wheels, playingWithWheel)
        configureAudio()
        ...
        commandArray = [PCSX2_BIN_PATH] if rom == "config" else \
              [PCSX2_BIN_PATH, "-nogui", rom]
