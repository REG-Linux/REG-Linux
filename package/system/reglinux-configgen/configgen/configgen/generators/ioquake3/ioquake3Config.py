        ...
        with open(filename, "r+") as file:
            ...
            for line in lines:
                ...
                if line.startswith("seta r_mode"):
                    ...
                    line = f'seta r_customwidth "{width}"\n'
                elif line.startswith("seta r_customheight"):
                    line = f'seta r_customheight "{height}"\n'
                # controllers
...
def setIoquake3Config(system, rom, playersControllers, gameResolution):
    ...
    subdirectories = next(walk(IOQUAKE3_ROMS_DIR))[1]
    ...
    defaults_to_add = [
        'seta r_mode "-1"\n',
        f'seta r_customwidth "{width}"\n',
        f'seta r_customheight "{height}"\n',
