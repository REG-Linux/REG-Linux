...
from .hypseusSingeConfig import HYPSEUS_BIN_PATH, HYPSEUS_DATA_DIR, HYPSEUS_CONFIG_GAMEPAD_PATH, HYPSEUS_CONFIG_PATH, SINGE_ROM_DIR, DAPHNE_ROM_DIR, HYPSEUS_CONFIG_FILE_PATH
