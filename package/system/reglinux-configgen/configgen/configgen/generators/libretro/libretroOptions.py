...
def generateCoreSettings(coreSettings, system, rom, guns, wheels):
    match system.config['core']:
        case 'cap32': configure_cap32(coreSettings, system)
        case 'atari800': configure_atari_800(coreSettings, system)
        case 'virtualjaguar': configure_virtual_jaguar(coreSettings, system)
        case 'handy': configure_handy(coreSettings, system)
        case 'vice_x64' | 'vice_x64sc' | 'vice_xscpu64': configure_commodore_64(coreSettings, system, guns)
        case 'vice_x128': configure_commodore_128(coreSettings, system)
        case 'vice_xplus4': configure_commodore_plus(coreSettings, system)
        case 'vice_xvic': configure_commodore_vic(coreSettings, system)
        case 'vice_xpet': configure_commodore_pet(coreSettings, system)
        case 'puae | puae2021': configure_commodore_puae(coreSettings, system)
        case 'dolphin': configure_dolphin(coreSettings, system)
        case 'o2em': configure_o2em(coreSettings, system)
        case 'mame': configure_mame(coreSettings, system)
        case 'same_cdi': configure_samecdi(coreSettings, system)
        case 'mame078plus': configure_mame2003_plus(coreSettings, system, guns)
        case 'mame0139': configure_mame2010(coreSettings, system)
        case 'vecx': configure_vecx(coreSettings, system)
        case 'dosbox_pure': configure_dosbox_pure(coreSettings, system)
        case 'bluemsx': configure_bluemsx(coreSettings, system)
        case 'pce | pce_fast': configure_pcengine(coreSettings, system)
        case 'quasi88': configure_quasi88(coreSettings, system)
        case 'np2kai': configure_np2kai(coreSettings, system)
        case 'mednafen_supergrafx': configure_mednafen_supergrafx(coreSettings, system)
        case 'pcfx': configure_pcfx(coreSettings, system)
        case 'mupen64plus-next': configure_mupen64plus_next(coreSettings, system, rom, wheels)
        case 'parallel_n64': configure_parallel_n64(coreSettings, system, rom, wheels)
        case 'desmume': configure_desmume(coreSettings, system)
        case 'melonds': configure_melonds(coreSettings, system)
        case 'melonsds': configure_melonsds(coreSettings, system)
        case 'tgbdual': configure_tgbdual(coreSettings, system)
        case 'gambatte': configure_gambatte(coreSettings, system)
        case 'mgba': configure_mgba(coreSettings, system)
        case 'vba-m': configure_vba_m(coreSettings, system)
        case 'nestopia': configure_nestopia(coreSettings, system, guns)
        case 'fceumm': configure_fceumm(coreSettings, system, guns)
        case 'mesen': configure_mesen(coreSettings, system)
        case 'pokemini': configure_pokemini(coreSettings, system)
        case 'snes9x': configure_snes9x(coreSettings, system, guns)
        case 'snes9x_next': configure_snes9x_next(coreSettings, system, guns)
        case 'bsnes': configure_bsnes(coreSettings, system, guns)
        case 'mesen-s': configure_mesen_s(coreSettings, system)
        case 'vb': configure_vb(coreSettings, system)
        case 'opera': configure_opera(coreSettings, system, rom)
        case 'xrick': configure_xrick(coreSettings, system)
        case 'scummvm': configure_scummvm(coreSettings, system)
        case 'flycast': configure_flycast(coreSettings, system, guns, wheels)
        case 'genesisplusgx': configure_genesisplusgx(coreSettings, system, guns)
        case 'picodrive': configure_picodrive(coreSettings, system)
        case 'yabasanshiro': configure_yabasanshiro(coreSettings, system)
        case 'kronos': configure_kronos(coreSettings, system, guns)
        case 'beetle-saturn': configure_beetle_saturn(coreSettings, system, guns, wheels)
        case 'px68k': configure_px68k(coreSettings, system)
        case '81': configure_81(coreSettings, system)
        case 'fuse': configure_fuse(coreSettings, system)
        case 'fbneo': configure_fbneo(coreSettings, system, rom, guns)
        case 'neocd': configure_neocd(coreSettings, system)
        case 'ppsspp': configure_ppsspp(coreSettings, system)
        case 'mednafen_psx': configure_mednafen_psx(coreSettings, system)
        case 'swanstation | duckstation': configure_swanstation(coreSettings, system, guns)
        case 'pcsx2': configure_pcsx2(coreSettings, system)
        case 'pcsx_rearmed': configure_pcsx_rearmed(coreSettings, system, guns)
        case 'theodore': configure_theodore(coreSettings, system)
        case 'potator': configure_potator(coreSettings, system)
        case 'prboom': configure_prboom(coreSettings, system)
        case 'tyrquake': configure_tyrquake(coreSettings, system)
        case 'mrboom': configure_mrboom(coreSettings, system)
        case 'hatarib': configure_hatarib(coreSettings, system)
