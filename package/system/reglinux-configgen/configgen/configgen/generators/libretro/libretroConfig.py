...
def createLibretroConfig(generator, system, controllers, metadata, guns, wheels, rom, bezel, shaderBezel, gameResolution, gfxBackend):
    ...
    gun_mapping = {
        ...
        "km_morpheuscast_xtreme" : { "default" : { "device":   4, "p1": 0, "p2": 1, "p3": 2, "p4": 3 } },
