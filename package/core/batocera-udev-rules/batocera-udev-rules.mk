...
define BATOCERA_UDEV_RULES_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0644 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/core/batocera-udev-rules/rules/*.rules    $(TARGET_DIR)/etc/udev/rules.d/
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/core/batocera-udev-rules/S15virtualevents $(TARGET_DIR)/etc/init.d/

	mkdir -p $(TARGET_DIR)/etc/usb_modeswitch.d
	#$(INSTALL) -m 0644 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/core/batocera-udev-rules/usb_modeswitch.d/*    $(TARGET_DIR)/etc/usb_modeswitch.d/
