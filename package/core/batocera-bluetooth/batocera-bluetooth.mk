...
define BATOCERA_BLUETOOTH_INSTALL_TARGET_CMDS
    ...
    cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/core/batocera-bluetooth/S29namebluetooth \
        $(TARGET_DIR)/etc/init.d/S29namebluetooth
    cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/core/batocera-bluetooth/S32bluetooth.template \
