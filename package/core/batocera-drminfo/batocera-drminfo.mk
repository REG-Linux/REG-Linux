...
define BATOCERA_DRMINFO_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(TARGET_CC) -I$(STAGING_DIR)/usr/include/drm -ldrm $(BR2_EXTERNAL_BATOCERA_PATH)/package/core/batocera-drminfo/$(BATOCERA_DRMINFO_MAIN) -o $(@D)/batocera-drminfo $(BATOCERA_DRMINFO_FLAGS)
endef
