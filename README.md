...
## Do you need help with REG Linux?
 ...
 - :sos: The most effective way is to join our [Discord Server](https://discord.gg/fRuETpyg) and go to the \#help-and-support channel
 - :neckbeard: There is a [REG Linux subreddit](https://www.reddit.com/r/reglinux/) that is fairly active
...
## How can you help REG Linux?
 ...
 - :dollar: If you like REG Linux, you can help us with a [Paypal donation](), it's always appreciated!
