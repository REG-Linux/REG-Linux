...
# Apply patches
PATCHES="${BR2_EXTERNAL_REGLINUX_PATH}/board/batocera/amlogic/s905/patches/uboot/*.patch"
...
cd amlogic-boot-fip && ./build-fip.sh nanopi-k2 ../u-boot.bin ../../../uboot-nanopi-k2/
