...
do
    ...
    #nope cp -pr "${BINARIES_DIR}/tools"              "${BATOCERA_BINARIES_DIR}/boot/" || exit 1
    ...
    (cd "${BATOCERA_BINARIES_DIR}/boot" && tar -I "zstd" -cf "${BATOCERA_BINARIES_DIR}/images/${BATOCERA_SUBTARGET}/boot.tar.zst" *) || exit 1
...
#### md5 and sha256 #######################
for FILE in "${BATOCERA_BINARIES_DIR}/images/"*"/boot.tar.zst" "${BATOCERA_BINARIES_DIR}/images/"*"/reglinux-"*".img.gz"
do
