...
ARCH=aarch64 make rock5b-rk3588_defconfig
ARCH=aarch64 make -j$(nproc)

# Copy generated files
mkdir -p "${IMAGES_DIR}/reglinux/uboot-rock-5b"
cp "${IMAGES_DIR}/reglinux/build-uboot-rock-5b/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-rock-5b/u-boot-rockchip.bin"
