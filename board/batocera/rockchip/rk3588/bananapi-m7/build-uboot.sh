...
ARCH=aarch64 make sige7-rk3588_defconfig
ARCH=aarch64 make -j$(nproc)

# Copy generated files
mkdir -p "${IMAGES_DIR}/reglinux/uboot-bananapi-m7"
cp "${IMAGES_DIR}/reglinux/build-uboot-bananapi-m7/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-bananapi-m7/u-boot-rockchip.bin"
