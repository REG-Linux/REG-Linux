...
ARCH=aarch64 make orangepi-5-rk3588s_defconfig
ARCH=aarch64 make -j$(nproc)

# Copy generated files
mkdir -p "${IMAGES_DIR}/reglinux/uboot-orangepi-5b"
cp "${IMAGES_DIR}/reglinux/build-uboot-orangepi-5b/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-orangepi-5b/u-boot-rockchip.bin"
