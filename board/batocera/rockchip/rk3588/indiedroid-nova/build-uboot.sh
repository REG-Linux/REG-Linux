...
PATCHES="${BR2_EXTERNAL_REGLINUX_PATH}/board/batocera/rockchip/rk3588/patches/uboot/*.patch"
...
ARCH=aarch64 make nova-rk3588s_defconfig
ARCH=aarch64 make -j$(nproc)

# Copy generated files
mkdir -p "${IMAGES_DIR}/reglinux/uboot-indiedroid-nova"
cp "${IMAGES_DIR}/reglinux/build-uboot-indiedroid-nova/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-indiedroid-nova/u-boot-rockchip.bin"
