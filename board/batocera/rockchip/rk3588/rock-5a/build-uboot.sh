...
ARCH=aarch64 make rock5a-rk3588s_defconfig
ARCH=aarch64 make -j$(nproc)

# Copy generated files
mkdir -p "${IMAGES_DIR}/reglinux/uboot-rock-5a"
cp "${IMAGES_DIR}/reglinux/build-uboot-rock-5a/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-rock-5a/u-boot-rockchip.bin"
