...
mkdir -p "${IMAGES_DIR}/reglinux/uboot-gameforce-ace"
cp "${IMAGES_DIR}/reglinux/build-uboot-gameforce-ace/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-gameforce-ace/u-boot-rockchip.bin"
