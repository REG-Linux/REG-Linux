...
mkdir -p "${IMAGES_DIR}/reglinux/uboot-orangepi-5"
cp "${IMAGES_DIR}/reglinux/build-uboot-orangepi-5/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-orangepi-5/u-boot-rockchip.bin"
