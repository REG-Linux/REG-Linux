...
mkdir -p "${IMAGES_DIR}/reglinux/uboot-khadas-edge-2"
cp "${IMAGES_DIR}/reglinux/build-uboot-khadas-edge-2/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-khadas-edge-2/u-boot-rockchip.bin"
