...
cp "${IMAGES_DIR}/reglinux/build-uboot-anbernic-rg552/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-anbernic-rg552/u-boot-rockchip.bin"
