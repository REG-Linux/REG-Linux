...
cp "${IMAGES_DIR}/reglinux/build-uboot-anbernic-rgxx3/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-anbernic-rgxx3/u-boot-rockchip.bin"

# TODO consider chainloading BSP u-boot to mainline boot for Android dual boot ?
#cp "${IMAGES_DIR}/reglinux/build-uboot-anbernic-rgxx3/u-boot-{UBOOT_VERSION}/u-boot.bin"          "${IMAGES_DIR}/reglinux/uboot-anbernic-rgxx3/u-boot.bin"
