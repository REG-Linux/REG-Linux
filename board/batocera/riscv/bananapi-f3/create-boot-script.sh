...
cp "${BINARIES_DIR}/k1-x_evb.dtb"     "${REGLINUX_BINARIES_DIR}/boot/dtbs/spacemit/" || exit 1
cp "${BINARIES_DIR}/k1-x_MINI-PC.dtb" "${REGLINUX_BINARIES_DIR}/boot/dtbs/spacemit/" || exit 1
cp "${BINARIES_DIR}/k1-x_MUSE-N1.dtb" "${REGLINUX_BINARIES_DIR}/boot/dtbs/spacemit/" || exit 1
cp "${BINARIES_DIR}/k1-x_MUSE-Pi.dtb" "${REGLINUX_BINARIES_DIR}/boot/dtbs/spacemit/" || exit 1
