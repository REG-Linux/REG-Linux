...
# Apply patches
PATCHES="${BR2_EXTERNAL_BATOCERA_PATH}/board/amlogic/s922x/patches/uboot/*.patch"
...
cd amlogic-boot-fip && ./build-fip.sh bananapi-m2s ../u-boot.bin ../../../uboot-bananapi_m2s/
