...
UBOOT_DEFCONFIG="tinker-s-rk3288_defconfig"
UBOOT_TARGET="tinker-s-rk3288"
...
cp "${BINARIES_DIR}/rk3288-tinker.dtb"      "${REGLINUX_BINARIES_DIR}/boot/boot/"     || exit 1
cp "${BINARIES_DIR}/rk3288-tinker-s.dtb"    "${REGLINUX_BINARIES_DIR}/boot/boot/"     || exit 1
