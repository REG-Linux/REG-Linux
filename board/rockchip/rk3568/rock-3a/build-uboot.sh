...
ARCH=aarch64 make rock-3a-rk3568_defconfig
ARCH=aarch64 SYSROOT="${HOST_DIR}" make -j$(nproc)

# Copy generated files
mkdir -p "${IMAGES_DIR}/reglinux/uboot-rock-3a"
cp "${IMAGES_DIR}/reglinux/build-uboot-rock-3a/u-boot-${UBOOT_VERSION}/u-boot-rockchip.bin" "${IMAGES_DIR}/reglinux/uboot-rock-3a/u-boot-rockchip.bin"
