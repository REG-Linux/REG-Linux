...
mkdir -p "${IMAGES_DIR}/reglinux/uboot-rock-pi-4"
...
# TODO this generates correct u-boot-dtb.bin but packing fails
# ARCH=aarch64 make rock-pi-4-rk3399_defconfig
# TODO so we use evb...
...
# Copy output
cp "${IMAGES_DIR}/reglinux/build-uboot-rock-pi-4/u-boot-${UBOOT_VERSION}/idbloader.img" "${IMAGES_DIR}/reglinux/uboot-rock-pi-4/idbloader.img"

# Rockchip trust.img
cd ../rkbin
./tools/trust_merger RKTRUST/RK3399TRUST.ini
# Copy output
cp "${IMAGES_DIR}/reglinux/build-uboot-rock-pi-4/rkbin/trust.img" "${IMAGES_DIR}/reglinux/uboot-rock-pi-4/trust.img"

# Pack U-Boot binary with Rockchip loaderimage tool
cd ../u-boot-${UBOOT_VERSION}
../rkbin/tools/loaderimage --pack --uboot u-boot-dtb.bin uboot.img 0x200000
# Copy output
cp "${IMAGES_DIR}/reglinux/build-uboot-rock-pi-4/u-boot-${UBOOT_VERSION}/uboot.img" "${IMAGES_DIR}/reglinux/uboot-rock-pi-4/uboot.img"
