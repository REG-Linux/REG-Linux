...
mkdir -p "${IMAGES_DIR}/reglinux/uboot-orangepi-800"
...
ARCH=aarch64 make orangepi-rk3399_defconfig
...
# Copy output
cp "${IMAGES_DIR}/reglinux/build-uboot-orangepi-800/u-boot-${UBOOT_VERSION}/idbloader.img" "${IMAGES_DIR}/reglinux/uboot-orangepi-800/idbloader.img"

# Rockchip trust.img
cd ../rkbin
./tools/trust_merger RKTRUST/RK3399TRUST.ini
# Copy output
cp "${IMAGES_DIR}/reglinux/build-uboot-orangepi-800/rkbin/trust.img" "${IMAGES_DIR}/reglinux/uboot-orangepi-800/trust.img"

# Pack U-Boot binary with Rockchip loaderimage tool
cd ../u-boot-${UBOOT_VERSION}
../rkbin/tools/loaderimage --pack --uboot u-boot-dtb.bin uboot.img 0x200000
# Copy output
cp "${IMAGES_DIR}/reglinux/build-uboot-orangepi-800/u-boot-${UBOOT_VERSION}/uboot.img" "${IMAGES_DIR}/reglinux/uboot-orangepi-800/uboot.img"
