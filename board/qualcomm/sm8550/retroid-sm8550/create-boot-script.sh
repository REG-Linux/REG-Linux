...
cp "${BINARIES_DIR}/qcs8550-retroidpocket-rp6.dtb"		"${REGLINUX_BINARIES_DIR}/boot/boot/"        || exit 1
cp "${BINARIES_DIR}/qcs8550-retroidpocket-rp6-top-dpad.dtb"	"${REGLINUX_BINARIES_DIR}/boot/boot/"        || exit 1
