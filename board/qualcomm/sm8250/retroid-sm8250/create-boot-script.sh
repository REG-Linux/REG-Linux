...
cp "${BINARIES_DIR}/sm8250-retroidpocket-rp5.dtb"       "${REGLINUX_BINARIES_DIR}/boot/boot/"           || exit 1
cp "${BINARIES_DIR}/sm8250-retroidpocket-flip2.dtb"    "${REGLINUX_BINARIES_DIR}/boot/boot/"           || exit 1
cp "${BINARIES_DIR}/sm8250-retroidpocket-rpmini.dtb"    "${REGLINUX_BINARIES_DIR}/boot/boot/"           || exit 1
