...
UBOOT_DEFCONFIG="libretech_all_h3_cc_h5_defconfig"
UBOOT_TARGET="tritium-h5"
...
cp "${BINARIES_DIR}/sun50i-h5-libretech-all-h3-cc.dtb" "${REGLINUX_BINARIES_DIR}/boot/boot/"     || exit 1
