...
UBOOT_DEFCONFIG="Nintendo_NES_Classic_Edition_defconfig"
UBOOT_TARGET="nintendo-nes-classic"
...
cp "${BINARIES_DIR}/sun8i-r16-nintendo-nes-classic.dtb"       "${REGLINUX_BINARIES_DIR}/boot/boot/" || exit 1
cp "${BINARIES_DIR}/sun8i-r16-nintendo-super-nes-classic.dtb" "${REGLINUX_BINARIES_DIR}/boot/boot/" || exit 1
