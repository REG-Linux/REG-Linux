...
cp "${BINARIES_DIR}/sun8i-h3-orangepi-pc.dtb"       "${REGLINUX_BINARIES_DIR}/boot/boot/"     || exit 1
cp "${BINARIES_DIR}/sun8i-h3-orangepi-pc-plus.dtb"  "${REGLINUX_BINARIES_DIR}/boot/boot/"     || exit 1
