...
Compiles U-Boot 2025.01 for an Allwinner H6 board, rebuilds ARM Trusted Firmware
for sun50i_h6, and stages u-boot-sunxi-with-spl.bin under
...
readonly ATF_PLATFORM="${UBOOT_ATF_PLATFORM:-sun50i_h6}"
...
readonly ATF_PATCH_DIR="${BR2_EXTERNAL_REGLINUX_PATH}/board/allwinner/h6/patches/arm-trusted-firmware"
...
COMMON_PATCH_DIR="${BR2_EXTERNAL_REGLINUX_PATH}/board/allwinner/h6/patches/u-boot"
...
COMMON_FRAGMENT="${BR2_EXTERNAL_REGLINUX_PATH}/board/allwinner/h6/uboot.config.fragment"
