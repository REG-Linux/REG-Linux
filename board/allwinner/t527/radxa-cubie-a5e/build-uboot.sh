...
PATCHES="${BR2_EXTERNAL_REGLINUX_PATH}/board/allwinner/t527/patches/uboot-radxa-cubie-a5e/*.patch"
...
mkdir -p "${IMAGES_DIR}/reglinux/uboot-radxa-cubie-a5e"
cp u-boot-sunxi-with-spl.bin ../../uboot-radxa-cubie-a5e/
