...
for arch in jz4770 bcm2835 bcm2836 s812 odroidxu4 rk3288 h5 bcm2711 bcm2712 rk3326 rk3399 rk3588 s905gen3 s922x saphira visionfive2 bpif3 x86_64 x86_64_v3; do
	# Clean
	make ${arch}-clean
	# Build
